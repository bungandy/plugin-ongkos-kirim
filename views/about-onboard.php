...
<div class="pok-onboard-content">
	<div class="row">
		<div class="col-half main-logo">
			...
			<div class="main-cta">
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=pok_setting' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to Settings', 'pok' ); ?></a>
				<?php if ( ! $this->helper->is_license_active() ) : ?>
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=pok_license' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Activate License', 'pok' ); ?></a>
				<?php endif; ?>
			</div>
		</div>
